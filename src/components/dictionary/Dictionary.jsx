...
const Dictionary = () => {
  ...
  return (
    <div className='sm:w-30 md:w-[500px] p-3 pb-6 w-[500px] gap-2 rounded-xl opacity-90 bg-white flex flex-col justify-center items-center text-black '>
        <h1 className='text-[42px] p-3 pt-6 fancy-font font-bold text-blue-700'>English Dictionary</h1>
        <div className='w-11/12'>
            ...
            <form action="" onSubmit={handleSearch} className='relative'>
                <textarea className=' border-2 w-full p-4 py-5 text-lg border-solid border-stone-400 text-black' placeholder='Enter the word'
        ...
        <div className='w-11/12 gap-2 flex flex-col bg-yellow-400 pl-1 '>
            <h1 className='text-3xl font-bold fancy-font'>{foundWord}</h1>
            <h3 className='text-l'>{phonetics}</h3>
            <h2 className='font-bold text-xl'>{partOfSpeech}</h2>
        </div>
        <div className='w-11/12 gap-2 flex flex-col  bg-slate-400 pl-1 '>
            <h2 className='text-xl font-bold'>Meaning:</h2>
            <h3 className='text-l'>{definition}</h3>
        </div>
        <div className='w-11/12 gap-2 flex flex-col justify-center bg-red-400 pl-1 '>
            <h2 className='text-xl font-bold'>Synonym:</h2>
            <h3 className='text-l'>{synonym}</h3>
        </div>
